...
class HttpKernel extends Kernel
{
    ...
    protected $middleware = [
        ...
        \Emtudo\Units\Core\Http\Middleware\TrimStrings::class,
        \Illuminate\Foundation\Http\Middleware\ConvertEmptyStringsToNull::class,
        \Emtudo\Units\Core\Http\Middleware\TrustProxies::class,
    ];
    ...
    protected $routeMiddleware = [
        ...
        'twoFactorVerify' => \Emtudo\Units\Core\Http\Middleware\TwoFactorVerify::class,
    ];
}

...
return [
     ...
     */
    'default_serializer' => Emtudo\Support\Domain\Repositories\Fractal\DataArraySerializer::class,
    ...
    'default_paginator' => Illuminate\Pagination\LengthAwarePaginator::class,
//    'default_paginator' => '',
